						...
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation" autocomplete="off" action="<?php echo e(route('register')); ?>">
								...
								<div class="form-group">
									...
									<input id="name" type="text" class="form-control" name="name"  autofocus placeholder="Enter name" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
								...
								<div class="form-group">
									...
									<input id="email" type="email" class="form-control" name="email"  placeholder="Enter email" value="<?php echo e(old('email')); ?>">
...
</html><?php /**PATH D:\XAMPP\htdocs\Laravel-8-multi-auth-based-on-Roles-with-examples-master\resources\views/auth/register.blade.php ENDPATH**/ ?>