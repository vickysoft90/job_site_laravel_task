                    ...
                    <div class="active tab-pane" id="personal_info">
                      <form class="form-horizontal" method="POST" action="<?php echo e(route('adminUpdateInfo')); ?>" id="AdminInfoForm">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputName2" placeholder="Favorite color" value="<?php echo e(Auth::user()->favoriteColor); ?>" name="favoritecolor">
...
<?php echo $__env->make('dashboards.admins.layouts.admin-dash-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\Laravel-8-multi-auth-based-on-Roles-with-examples-master\resources\views/dashboards/admins/profile.blade.php ENDPATH**/ ?>