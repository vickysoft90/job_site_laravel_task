          ...
          alert(data.msg);
              if(data.status == 0){
                ...
                $('.admin_name').each(function(){
                   $(this).html( $('#registerUser').find( $('input[name="name"]') ).val() );
                });
                alert(data.msg);
              }
         }
...
<?php /**PATH D:\XAMPP\htdocs\Laravel-8-multi-auth-based-on-Roles-with-examples-master\resources\views/dashboards/users/layouts/user-dash-layout.blade.php ENDPATH**/ ?>